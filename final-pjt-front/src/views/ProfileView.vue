<template>
  ...
  <div v-if="profile" class="container">
    <h1 class="pt-4 fw-bold">{{ username }}님의 프로필</h1>

    <h4 class="mt-3 mb-3 fw-bold">{{ username }}님이 좋아한 영화</h4>
    ...
    <h4 class="mt-3 mb-3 fw-bold">{{ username }}님이 좋아하지 않는 영화</h4>
    ...
    <div v-else>좋아하지 않는 영화가 없습니다.</div>

    <h4 class="mt-3 mb-3 fw-bold">{{ username }}님이 작성한 리뷰</h4>
